        ...
        const edges = allLinks.map(l => {
            ...
            return {
                data: {
                    ...
                    wsPath: l.wsPath || '/cascade',
                    wsHost: l.wsHost || '',
                    grpcServiceName: l.grpcServiceName || 'cascade',
                    xhttpPath: l.xhttpPath || '/cascade',
                    xhttpHost: l.xhttpHost || '',
                    xhttpMode: l.xhttpMode || 'auto',
                    realityDest: l.realityDest || 'www.google.com:443',
                    realitySni: Array.isArray(l.realitySni) ? l.realitySni : [],
                    realityFingerprint: l.realityFingerprint || 'chrome',
                    realityShortIds: Array.isArray(l.realityShortIds) ? l.realityShortIds : [''],
                    geoRouting: {
                        enabled: !!l.geoRouting?.enabled,
                        domains: Array.isArray(l.geoRouting?.domains) ? l.geoRouting.domains : [],
                        geoip: Array.isArray(l.geoRouting?.geoip) ? l.geoRouting.geoip : [],
                    },
                    portalType,
                    bridgeType,
